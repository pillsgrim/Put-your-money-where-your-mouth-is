...
contract putYourMoney is Ownable{
    ...
    */
    ...
    //1532268549,1537625349 are harcoded, replace with now
    ...
    function transferStep2(address to) returns(bool)  {
        ...
        require (1532268549 >= clients[id-1].creationTime + 1 days);
    ...
    function transferStep3(address to) returns(bool)  {
        ...
        require (1537625349 >= clients[id-1].creationTime + 7 days);
